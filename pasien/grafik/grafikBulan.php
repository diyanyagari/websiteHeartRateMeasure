...
<?php
	...
	$carinama = mysqli_query($con, "select * from pasien WHERE kode='$kode'");
	while ($nm = mysqli_fetch_array($carinama))
	{
		$nama = $nm['nama'];
	}
	/*for($i=2006;$i<=2011;$i++){
...
<div style="text-align: center">
	<br><br>
	<?php
		echo "<a href='../indexedit.php?nama=".$nama."' style='font-size: 40px; text-decoration: none'>Kembali</a>"
	?>
</div>
</div>
